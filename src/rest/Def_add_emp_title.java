...
public class Def_add_emp_title extends javax.swing.JFrame {

    public Def_add_emp_title() {
        initComponents();
    }
    
    public void addTtl() throws SQLException{
        try {
            _db.dbCon();
            String sql = "INSERT INTO public.hr_emp_ttl(emp_dep_name)VALUES (?)";
            ...
            JOptionPane.showMessageDialog(rootPane, "Ünvan Kayıdı Yapılmıştır");
        } catch (SQLException e) {
            System.out.println(e.getMessage());
            JOptionPane.showMessageDialog(rootPane, "Ünvan Kayıdı Yapılamamıştır !");
        }
    }
