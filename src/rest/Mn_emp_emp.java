...
public class Mn_emp_emp extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(170, 10, 100, 90);

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tüm Personeller", "Kullanıcılar", " " }));
        jPanel1.add(jComboBox1);
        jComboBox1.setBounds(10, 30, 160, 27);

        jButton2.setText("Personel Yetkileri");
        jPanel1.add(jButton2);
        jButton2.setBounds(380, 10, 90, 90);

        jButton3.setText("Personel Sil");
        jButton3.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jButton3.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        jPanel1.add(jButton3);
        jButton3.setBounds(270, 10, 110, 90);

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tüm Departmanlar", "Yönetim", "İnsan Kaynakları", "Mutfak", "Servis", "Temizlik" }));
        jPanel1.add(jComboBox2);
        jComboBox2.setBounds(10, 60, 160, 27);
